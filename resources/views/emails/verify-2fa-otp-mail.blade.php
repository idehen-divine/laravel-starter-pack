...
<head>
    ...
    <title>StarterPack - Two-Factor Authentication Verification</title>
</head>
                ...
                <table cellpadding="0" cellspacing="0" width="100%"  style="max-width: 600px; width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF" style="padding: 40px 30px;">
                            ...
                            <p style="font-size: 16px; color: #333333;">
                                A login attempt was made on your account. Use the OTP below to complete the login:
                            </p>
                            <div style="font-size: 24px; font-weight: bold; text-align: center; color: #2DBB54;">
                                {{ $otp }}
                            </div>
                            <p style="font-size: 16px; color: #333333;">
                                If you did not attempt to log in, please change your password immediately or contact our
                                support team at
